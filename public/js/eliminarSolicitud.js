...
botones.forEach(boton => {
	...
	boton.addEventListener("click", function(){
		...
		const confirm = window.confirm("Desea eliminar el examen: "+ idSolicitudExamen);

		if(confirm){
			//ejecutamos AJAX

			httpRequest("http://localhost/Extemporaneos/alumnos/consultarExamenes/eliminarExamen/"+ idSolicitudExamen, function(){
